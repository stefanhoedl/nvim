...
alias nvc="$HOME/.config/nvim/nvim.appimage ~/phd/Chemical_Language_Model_Explainer"
...
plugins=(git debian tmux zsh-vi-mode python)
# vi-mode
...
__conda_setup="$('/home/stefan/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
